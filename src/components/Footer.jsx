  ...
  return (
    <footer className="app-footer">
      <div className="app-footer__container">
        ...
        {/* COLUNA ESQUERDA: Textos Animados */}
        <motion.div 
          className="app-footer__info"
        ...
        >
          <div className="app-footer__section">
            ...
            <p className="app-footer__value">Veterana Akaésse Kaonny</p>
          </div>

          <div className="app-footer__section">
            <h4 className="app-footer__label">Organização</h4>
            <p className="app-footer__value">Capoeira Nagô Monte Carmelo</p>
          </div>
          ...
          <div className="app-footer__socials">
            ...
            <motion.a 
              href="https://chat.whatsapp.com/KWnoLReaquvFJ3s7Tywufq" 
              target="_blank" 
              whileHover={{ scale: 1.2 }}
              className="app-footer__social-link"
            >
